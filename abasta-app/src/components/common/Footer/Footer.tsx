        ...
        <div className="row align-items-start">
          ...
          <div className="col-6 col-md-4 d-flex flex-column justify-content-between text-start mb-2 mb-md-0" style={{ height: "150px" }}>
            ...
            <p className="footer-contact text-break mb-0">
              <a href="mailto:abasta.platform@gmail.com" className="text-decoration-none text-light">
          ...
          <div className="col-6 col-md-4 text-center mb-2 mb-md-0">
            ...
            <p className="footer-copyright">
              © 2025 Abasta. Tots els drets reservats.<br />
              <a href="#">Política de privacitat</a>{" · "}<a href="#">Termes i condicions</a>
            </p>
          </div>
