...
/**
 * DTO per gestionar les peticions de cerca bàsica d'usuaris en múltiples camps.
 * Conté els paràmetres necessaris per realitzar cerques simples amb paginació i ordenació.
 *
 * <p>Aquest DTO s'utilitza en l'endpoint de cerca bàsica quan es vol filtrar usuaris
 ...
 *   <li><strong>Cerca en múltiples camps</strong> - Filtra en email, firstName, lastName i phone</li>
 ...
 *   <li><strong>Control d'accés</strong> - Només usuaris amb rol ADMIN poden accedir</li>
 * </ul>
 * </p>
 *
 ...
 * </pre>
 *
 * <strong>2. Cercar usuaris que continguin "John" en qualsevol camp:</strong>
 * <pre>
 ...
 * cada usuari només pugui cercar usuaris de la seva pròpia empresa. Només usuaris
...
public class UserSearchDTO {
    ...
    /**
     * Text a cercar en múltiples camps de l'usuari (cerca parcial opcional, insensible a majúscules).
     ...
     * Per defecte s'ordena per email.
     */
    @Builder.Default
